...
let prefered = userPreference==="Regular" || userPreference==="Sugar-free"? userPreference : "Regular";
...
// if the temperature is below or equal to 5°C, or "Needs a cooler!" if above 5°C.
 ...
 let chill = currentTemp <=5 ? "Chilled to perfection!" : "Needs a cooler!";
  console.log(chill);
...
// Define the current hour in 24-hour format
 let currentHour = 6;
 let energyDrink = currentHour >=7 && currentHour<=24 ?  "Unleash the beast!" : "Better stick to water.";
